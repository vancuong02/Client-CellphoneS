          ...
          <div className="dashboard-middle-statistic">
            <div className="dashboard-middle-statistic-content">
              <li>
                ...
                <div className="dashboard-middle-statistic-title">
                  <span className="total">{quantityProduct}</span>
            ...
            <div className="dashboard-middle-statistic-content">
              <li>
                ...
                <div className="dashboard-middle-statistic-title">
                  <span className="total">{quantityOrder}</span>
            ...
            <div className="dashboard-middle-statistic-content">
              <li>
                ...
                <div className="dashboard-middle-statistic-title">
                  <span className="total">{formatPrice(totalSales)}</span>
            ...
            <div className="dashboard-middle-statistic-content">
              <li>
                ...
                <div className="dashboard-middle-statistic-title">
                  <span className="total">{quantityUsers}</span>
